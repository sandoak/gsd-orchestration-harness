...
- This section feeds directly into /harness:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /harness:plan-phase --gaps with root causes
...
**Creation:** When /harness:verify-work starts new session
