...
Template for spawning harness-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
Task(
  ...
  subagent_type="harness-debugger",
...
```python
Task(prompt=template, subagent_type="harness-debugger", description="Debug UAT-001")
```
