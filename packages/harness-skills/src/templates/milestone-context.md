...
**Purpose:** Persist milestone discussion context so `/clear` can be used between commands. This file is consumed by `/harness:new-milestone` and deleted after the milestone is created.
...
**Generated:** [date]
**Status:** Ready for /harness:new-milestone
...
_This file is temporary. It will be deleted after /harness:new-milestone creates the milestone._
```
...
1. `/harness:discuss-milestone` creates this file at end of discussion
2. User runs `/clear` (safe now - context is persisted)
3. `/harness:new-milestone` reads this file
4. `/harness:new-milestone` uses context to populate milestone
5. `/harness:new-milestone` deletes this file after successful creation
