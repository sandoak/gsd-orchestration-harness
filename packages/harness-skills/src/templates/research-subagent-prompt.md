...
Template for spawning harness-researcher agent. The agent contains all research expertise - this template provides research context only.
...
**Note:** Research methodology, tool strategy (Context7 > Official > WebSearch), and verification protocols are baked into the harness-researcher agent. This template only passes context.
