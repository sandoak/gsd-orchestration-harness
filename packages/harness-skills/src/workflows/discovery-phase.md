...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /harness:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ./.harness/skills/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Quality check:** Before finalizing findings, consult ./.harness/skills/references/research-pitfalls.md to avoid common research gaps.

7. **Create DISCOVERY.md** using ./.harness/skills/templates/discovery.md structure:
...
1. **Scope the discovery** using ./.harness/skills/templates/discovery.md:
   - Define clear scope
...
6. **Quality check:** Before finalizing findings, consult ./.harness/skills/references/research-pitfalls.md to ensure comprehensive coverage and avoid common research gaps.

7. **Create comprehensive DISCOVERY.md:**
   - Full structure from ./.harness/skills/templates/discovery.md
...
Use ./.harness/skills/templates/discovery.md.
...
1. Discuss phase context (/harness:discuss-phase [current-phase])
2. Create phase plan (/harness:plan-phase [current-phase])
