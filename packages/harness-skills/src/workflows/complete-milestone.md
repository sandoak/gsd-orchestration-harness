...
2. Read `./.harness/skills/templates/milestone-archive.md` template
...
**Important:** The next milestone workflow starts with `/harness:define-requirements` to create a fresh REQUIREMENTS.md. PROJECT.md's Validated section carries the cumulative record across milestones.
...
**Next milestone flow:**
1. `/harness:discuss-milestone` — thinking partner, creates context file
2. `/harness:new-milestone` — update PROJECT.md with new goals
3. `/harness:research-project` — (optional) research ecosystem
4. `/harness:define-requirements` — scope what to build
5. `/harness:create-roadmap` — plan how to build it
...
- [ ] User knows next steps (starting with /harness:define-requirements)
