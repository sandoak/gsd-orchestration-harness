...
- ./.harness/skills/references/goal-backward.md (derivation process)
- ./.harness/skills/references/verification-patterns.md (detection patterns)
- ./.harness/skills/templates/verification-report.md (output format)
  </required_reading>
...
See ./.harness/skills/references/goal-backward.md for detailed derivation guidance.
</step>
...
See ./.harness/skills/templates/verification-report.md for complete template.
</step>
