...
1. ./.harness/skills/references/questioning.md
2. ./.harness/skills/templates/project.md
...
**If MILESTONE-CONTEXT.md exists (from /harness:discuss-milestone):**
...
_Last updated: [date] after v[X.Y] milestone start_
```
...
Phase: Not started (run /harness:create-roadmap)
Plan: —
...
- `/harness:research-project` — investigate ecosystem before scoping

**Full flow:**

1. `/harness:define-requirements` — create REQUIREMENTS.md
2. `/harness:create-roadmap` — create ROADMAP.md with phases
3. `/harness:plan-phase [N]` — start execution
