...
Use /harness:progress to see available phases.
```
...
Use template from ./.harness/skills/templates/context.md
...
**Also available:**
- `/harness:research-phase ${PHASE}` — investigate unknowns
