...
Exit skill and invoke SlashCommand("/harness:plan-phase [X+1]")
...
**Also available:**
- `/harness:discuss-phase [X+1]` — gather context first
- `/harness:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/harness:complete-milestone {version}")
...
`/harness:complete-milestone {version}`
