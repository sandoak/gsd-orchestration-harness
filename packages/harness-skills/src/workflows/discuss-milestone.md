...
Did you want to:
1. Complete current milestone first (/harness:complete-milestone)
2. Add phases to current milestone (/harness:add-phase)
...
- options (ALL THREE REQUIRED):
  - "Create milestone" - Proceed to /harness:new-milestone
...
Use template from ./.harness/skills/templates/milestone-context.md
...
*This file is temporary. It will be deleted after /harness:new-milestone creates the milestone.*
EOF
```
...
- Context handed off to /harness:new-milestone
  </success_criteria>
